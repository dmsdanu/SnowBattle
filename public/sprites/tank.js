var Tank = function(scene, layer, game, id, imageUrl){
  ...
  this.game = game;
  this.setDom();
  this.faction = (id % 2 == 0) ? "Warrior" : "Paladin";
 // document.getElementById('faction').innerHTML = getPar("faction");
	  //document.getElementById('faction').innerHTML;
  //alert(this.faction+"!!");
  this.src = (this.faction == 'Warrior') ? '1' : '3';
  this.loadImg('assets/images/char/' + this.src + '.png');
...
//	this.loadImg('assets/images/char/' + this.src + 'back.png');
  this.scale(1, 1);
...
//	this.loadImg('assets/images/char/' + this.src + 'right.png');
  this.scale(-1, 1);
...
//	this.loadImg('assets/images/char/' + this.src + 'left.png');
  this.scale(1, 1);
...
Tank.prototype.giveScoresForHit = function giveScoresForHit(points){
  this.score += points;
  this.updateScreenScore();
}
